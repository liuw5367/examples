...
import { RootModelType } from '../models';
import { ModelType } from './redux';
 ...
 */
export type Action<P = any, T extends AllModelActionTypes = AllModelActionTypes> = P extends NoParam
  ? {
      type: T;
      payload?: any;
    }
